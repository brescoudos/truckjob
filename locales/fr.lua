Locales['fr'] = {
  ...
  ['truck_wear'] = 'tenue truck',
  ['dockwork_wear'] = 'dockwork Outfit',
  ...
  ['armory'] = 'armurerie',
  ['open_armory'] = 'appuez sur ~INPUT_CONTEXT~ pour accéder au \'armurerie',
  -- Vehicles
  ['vehicle_menu'] = 'véhicule',
  ['vehicle_out'] = 'il y a déja un véhicule de sorti',
  ['vehicle_spawner'] = 'appuez sur ~INPUT_CONTEXT~ pour sortir un camion est remorque',
  ['store_vehicle'] = 'appuez sur ~INPUT_CONTEXT~ pour ranger le camion est remorque',
  ...
  ['search'] = 'fouiller',
  ['handcuff'] = 'attaché / Détaché',
  ['drag'] = 'Escorter',
  ['put_in_vehicle'] = 'jeter dans le camion',
  ['out_the_vehicle'] = 'sortir du camion',
  ['fine'] = 'Facture',
